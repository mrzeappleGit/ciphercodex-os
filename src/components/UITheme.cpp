...
#include "components/themes/cipher/CipherTheme.h"
...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::LYRA_3_COVERS:
      ...
      break;
    case CrossPointSettings::UI_THEME::CIPHER:
      LOG_DBG("UI", "Using Cipher theme");
      currentTheme = std::make_unique<CipherTheme>();
      currentMetrics = &CipherMetrics::values;
      break;
  }
}
